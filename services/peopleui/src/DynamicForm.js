...
import {Bootstrap, Grid, Row, Col, FormGroup, FormControl, ControlLabel, HelpBlock, Radio, Checkbox} from 'react-bootstrap';
...
export default  class DynamicForm extends React.Component {
    ...
    renderForm = () => {
        let model = this.props.model; //switch this to get model from api
        let defaultValues = this.props.defaultValues; //switch this to get defaults from api
